...
class IAFireballPower(AnimatedSprite):
    # Máquina de estados.
    NORMAL = 0
    ...
    def __init__(self, char):
        ...
        self.setBounds(0 - self.getWidth(), 0 - self.getHeight(), GameConstants.inst().SCREEN_WIDTH + self.getWidth(), GameConstants.inst().SCREEN_HEIGHT + self.getHeight())
        self.setBoundAction(self.DIE)
        ...
        # Estado inicial.
        self.setState(IAFireballPower.NORMAL)
